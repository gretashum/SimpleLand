...
!	 real(r8), pointer :: mml_nc_evaprs_grc    			(:)   => null() ! gridcell level evaporative resistance (prescribed)
	...
	! Hydrology:
	real(r8), pointer :: mml_atm_prec_liq_grc    (:)   => null() ! liquid precipitation (rain) [m/s]
	real(r8), pointer :: mml_atm_prec_frz_grc	 (:)   => null() ! frozen precipitation (snow) [m/s]
...
!         ptr_lnd=this%mml_nc_snoalb_grc)
   ...
   ! write(iulog,*)  'MML write to h0: atm vars '
    ...
    call hist_addfld1d (fname='MML_prec_liq', units='m/s',  &
